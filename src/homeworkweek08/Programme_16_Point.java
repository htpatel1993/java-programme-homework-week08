 ...
 * constructor). The second constructor has parameters x and y of type int and it needs to initialize the fields.
...
public class Programme_16_Point {
    ...
    //method without params with return values of x,y
    public int getX() {
        return x;
    }
